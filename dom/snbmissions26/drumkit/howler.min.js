! function() {
    ...
    o.prototype = {
        ...
        play: function(e, o) {
            ...
            var p = function() { i._paused = !1, i._seek = _, i._start = c, i._stop = f, i._loop = !(!i._loop && !t._sprite[e][2]) };
